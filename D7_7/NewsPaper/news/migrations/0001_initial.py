...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('news_category', models.CharField(choices=[('CU', 'Культура'), ('SC', 'Наука'), ('TE', 'Технологии'), ('PO', 'Политика'), ('SP', 'Спорт'), ('EN', 'Развлечения'), ('EC', 'Экономика'), ('ED', 'Образование')], max_length=2, unique=True)),
            ],
        ),
        migrations.CreateModel(
            name='Post',
